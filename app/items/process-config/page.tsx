...
export default function ItemsProcessConfigPage() {
  ...
  if (!allowed) {
    return (
      <div className="space-y-3 p-4">
        ...
        <p className="text-sm font-bold text-amber-800">시스템 관리자(관리자 역할 또는 시스템 관리 권한)만 이 화면을 사용할 수 있습니다.</p>
        <Button asChild variant="outline" size="sm">
          <Link href="/items">← 품목 관리</Link>
        </Button>
      </div>
    )
  }

  return <ItemProcessConfigEditor backHref="/items" backLabel="← 품목 관리" />
}
