...
async function getOutboundRequestDetail(supabase: SupabaseClient, id: string) {
...
export default async function OutboundRequestDetailPage({ params }: { params: Promise<{ id: string }> }) {
